...
public class MarkdownViewRendererTest extends JerseyTest {
    static {
    ...
    protected AppDescriptor configure() {
        ...
        ViewRenderer renderer = new MarkdownViewRenderer();
    ...
    public void rendersViewsWithAbsoluteTemplatePaths() throws Exception {
        ...
        assertThat(response).isEqualTo("<h1>Woop woop.</h1>\n");
    }
    ...
    public void returnsA500ForViewsWithBadTemplatePaths() throws Exception {
        try {
            ...
            assertThat(e.getResponse().getEntity(String.class))
                    .isEqualTo("<html><head><title>Missing Template</title></head><body><h1>Missing Template</h1><p>/woo-oo-ahh.txt.md</p></body></html>");
        }
    }
