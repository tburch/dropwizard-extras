...
public class TwigViewRendererTest extends JerseyTest {
    static {
    ...
    protected AppDescriptor configure() {
        ...
        ViewRenderer renderer = new TwigViewRenderer();
    ...
    public void returnsA500ForViewsWithBadTemplatePaths() throws Exception {
        try {
            ...
            assertThat(e.getResponse().getEntity(String.class))
                    .isEqualTo("<html><head><title>Missing Template</title></head><body><h1>Missing Template</h1><p>/woo-oo-ahh.twig</p></body></html>");
        }
    }
